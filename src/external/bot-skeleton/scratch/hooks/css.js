/**
 * Array making up the CSS content for window.Blockly.
 */
window.Blockly.Css.CONTENT = [
  ...
  */
    ...
    'border: 1px solid;',
    'border-radius: 4px;',
    `box-shadow: 0px 0px 8px 1px ${window.Blockly.Colours.dropDownShadow};`,
    'padding: 4px;',
    '-webkit-user-select: none;',
    'min-height: 15px',
    '}',
    ...
    `box-shadow: 0px 0px 0px 4px ${window.Blockly.Colours.fieldShadow};`,
    '}',

    '.blocklyDropDownButton:active {',
    `box-shadow: 0px 0px 0px 6px ${window.Blockly.Colours.fieldShadow};`,
    '}',
  ...
  */
    ...
    '.blocklyAngleCircle {',
    `stroke: ${window.Blockly.Colours.motion.tertiary};`,
    'stroke-width: 1;',
    `fill: ${window.Blockly.Colours.motion.secondary};`,
    '}',
    ...
    `fill: ${window.Blockly.Colours.motion.primary};`,
    `stroke: ${window.Blockly.Colours.motion.tertiary};`,
    '}',
