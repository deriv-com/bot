...
//         window.Blockly.Events.fire(new window.Blockly.Events.Create(new_block));
//     }
...
//         // Calculate the old block position in pixels relative to the origin
//         const old_block_pos_pixels = {
//             x: event.clientX ? event.clientX - x_offset : 0,
//             y: event.clientY ? event.clientY - y_offset : 0,
//         };

//         // The position of the old block in pixels relative to the origin of the main workspace.
//         const final_offset_pixels = {
//             x: old_block_pos_pixels.x - main_offset_pixels.x,
//             y: old_block_pos_pixels.y - main_offset_pixels.y,
//         };

//         // The position of the old block in main workspace coordinates.
//         const final_offset_main_ws = {
//             x: final_offset_pixels.x / main_workspace.scale,
//             y: final_offset_pixels.y / main_workspace.scale,
//         };
