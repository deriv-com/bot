export const initTrashCan = (margin = 16, height = 36) => {
     ...
     * @private
     */
    window.Blockly.Trashcan.prototype.MARGIN_BOTTOM_ = margin * 2 + height; // eslint-disable-line
     ...
     * @private
     */
    window.Blockly.Trashcan.prototype.MARGIN_SIDE_ = margin; // eslint-disable-line
